...
public class chartsAction implements CommandAction {
	@Override
...
//			  
			  ...
			  albumsDTO albums=dao.printSingleAlbum(albumID); 			  
...
//			   System.out.println(albumName);
			   ...
			   String a_content = albums.getA_content();			
			   String a_imgDir = albums.getA_imgDir();
