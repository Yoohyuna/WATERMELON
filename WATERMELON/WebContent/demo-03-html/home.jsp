...
<title>Adonis Demo-03 | Home</title>
...
<link
	...
	rel="stylesheet">
<link href="../assets/vendors/owl/css/owl.carousel.min.css"
	rel="stylesheet">
<link
...
<!--  jQuery JavaScript -->
<script src="/WaterMelon/assets/js/jquery-3.3.1.min.js"></script>
<script>
function musicplay() {
<%-- 	$('.water-play-button').load('/WaterMelon/MusicPlay.water?t_ID=<%=t_ID%>'); --%>
}
</script>
<script>
	$(function() {
		$('.water-play-button').load('/WaterMelon/MusicPlay.water?t_ID=<%=t_ID%>');
		$('.water-nextplay-button').click(function() {
			<%
			++t_ID;
			%>
			$('.water-nextplay-button').load('/WaterMelon/MusicPlay.water?&next=true');
		})
		$('.water-preplay-button').click(function() {
			<%
			--t_ID;
			%>
			$('.water-preplay-button').load('/WaterMelon/MusicPlay.water?pre=true');
		})
	});
</script>
</head>
...
<div id="musicPlay"></div>
								...
								<div class="media current-item">
									<div class="mr-3 song-poster sm">
										<img class="box-rounded-sm"
											src="../assets/images/hot-song/hot-14.jpg" alt="">
									</div>
									<div class="des">
							...
							<div
								...
								<div
									...
									<div
										...
										<a class="water-preplay-button mr-1" role="button"
											tabindex="0"><span class="adonis-icon icon-5x"><svg
										...
										<a id="ppbutton"
											class="water-play-button ml-sm-3 mr-sm-3 fs-6" role="button"
											tabindex="0"> <span class="adonis-icon icon-play icon-2x"><svg
												...
												<path
													d="M1.6 0h8c0.884 0 1.6 0.716 1.6 1.6v28.8c0 0.884-0.716 1.6-1.6 1.6h-8c-0.884 0-1.6-0.716-1.6-1.6v-28.8c0-0.884 0.716-1.6 1.6-1.6z"></path></svg>
										</span>
										</a>
										<!-- 										<a class="jp-next" role="button" tabindex="0"><span -->
										<a class="water-nextplay-button" role="button" tabindex="0"><span
								...
								<div class="col-12 d-none d-xl-flex align-items-center">
									...
									<div class="jp-duration ml-3" role="timer"
								...
								<div
									...
									<a class="mr-3 adonis-mute-control" role="button" tabindex="0">
										...
										<span class="adonis-icon icon-mute icon-3x"><svg
												...
												viewBox="0 0 18.75 11.95"> <g data-name="Layer 2">
											<g id="Group_4" data-name="Group 4"> <path
											...
											<g id="sound_2" data-name="sound 2"> <path class="cls-1"
					...
					<div class="adonis-playlist-player adonis-player player-bg-yellow">
						...
						<div class="media current-item">
							<div class="song-poster mb-4 col-4 p-0">
								<img class="box-rounded-sm"
									src="../assets/images/playlists/playlist-2.jpg" alt="">
							</div>
									...
									<div class="fs-3">
										<a class="jp-shuffle inactive-color mr-3 ml-0" role="button"
											tabindex="0"> <span class="adonis-icon icon-2x"><svg
													version="1.1" xmlns="http://www.w3.org/2000/svg"
													height="15" viewBox="0 0 38 32"> <path
											...
											tabindex="0"><span class="adonis-icon icon-3x"><svg
													version="1.1" xmlns="http://www.w3.org/2000/svg"
													height="15" viewBox="0 0 44 32"> <path
									...
									<div class="lh-0 align-items-center d-flex">
										<a href="#" class="inactive-color fs-3"><span
											class="adonis-icon icon-2x"><svg
													...
													xlink:href="#icon-heart-blank"></use></svg></span></a> <a href="#"
			...
			<div id="primary-menu-offcanvas"
				...
				<div
					...
					<ul class="side-nav adonis-effect" data-animation="menuTwo"
						...
						<li class="nav-item has-dropdown"><a class="nav-link"
							href="#" data-level="2">Shop <span
						...
						<li class="nav-item has-dropdown"><a class="nav-link"
							href="#" data-level="2">More<span class="adonis-icon icon-sm"><svg
										xmlns="http://www.w3.org/2000/svg" version="1.1" height="10">
									<use xlink:href="#arrow-right" /></svg></span></a>
							<ul class="sub-level">
								<li><a href="#" class="go-back" data-level="1">Back</a></li>
			...
			<div class="master-container-fluid header-inner mb-3 mb-md-4 mt-3">
				<div class="row justify-content-between">
					<div class="col-auto col-xl-3 d-flex align-items-center pr-0">
						<div class="brand">
							<a
								class="brand d-flex align-items-center nav-link adonis-ajax-load"
								href="homl.jsp#site-content" data-target="homl.jsp#site-content"
								data-content="homl.jsp"> <!-- <a class="nav-link adonis-ajax-load" href="single-album.html" data-target="single-album.html" data-content="../demo-03-html/single-album.html">수민</a> -->
					...
					<div
						...
						<div>
							<a class="nav-link" id="btn-search-4" href="#"><span
								...
								<div class="flex-row d-inline-flex">
									<div class="user">
										<img class="rounded-circle"
											src="../assets/images/user-thumb-1.jpg" alt="">
									</div>
									<span class="ml-2 mt-2 fs-1 d-none d-lg-block"><%=dto.getNickname()%></span>
								</div>
							</a>
							<div
								...
								<div class="settings-top">
									<div class="user-cover-image">
										<img src="../assets/images/user/cover.gif" alt="">
	</div>
									<div class="user-profile-image rounded-circle">
										<img
											src="/WaterMelon/assets/images/browse/browse-overview-6.jpg"
											alt="">
									</div>
									<p>
								...
								<div class="settings-bottom">
									<h5 class="user-name text-center"><%=dto.getNickname()%></h5>
									<ul class="user-settings-menu list-unstyled">
										<li><a href="#" class="inactive-color"
											onclick="location.href='/WaterMelon/accountList.water?id=<%=dto.getId()%>'"><span
										...
										<li><a href="#" class="inactive-color"><span
												...
												MyList</a></li>
										<li><a href="#" class="inactive-color"
											onclick="location.href='../account/Logout.jsp'"><span
												class="adonis-icon mr-3 icon-2x"><svg version="1.1"
														xmlns="http://www.w3.org/2000/svg" height="32"
														viewBox="0 0 32 32"> <path
						...
						<div class="nav-item position-relative">
							<a class="nav-link dropdown-toggle w-nowrap pl-0 pr-0 pl-md-3"
								...
								<div class="flex-row d-inline-flex">
									...
									<span class="ml-2 mt-2 fs-1 d-none d-lg-block">Login</span>
								</div>
							</a>
							<div
								class="dropdown-menu dropdown-menu-right user-settings-dropdown clearfix"
								...
								<div class="settings-bottom">
									...
									<ul class="user-settings-menu list-unstyled">
										<li><a href="#" class="inactive-color"
											onclick="location.href='/WaterMelon/sign.water'"><span
												class="adonis-icon notification mr-3 icon-3x"><svg
														version="1.1" xmlns="http://www.w3.org/2000/svg"
														viewBox="0 0 32 32"> <path
														d="M10 6c0-3.314 2.686-6 6-6s6 2.686 6 6c0 3.314-2.686 6-6 6s-6-2.686-6-6zM24.002 14h-1.107l-6.222 12.633 2.327-11.633-3-3-3 3 2.327 11.633-6.222-12.633h-1.107c-3.998 0-3.998 2.687-3.998 6v10h24v-10c0-3.313 0-6-3.998-6z"></path></svg></span>Login/Sign
												up</a></li>
										<li><a href="#" class="inactive-color"
											onclick="location.href='/WaterMelon/accountFind.water'"><span
												class="adonis-icon mr-3 icon-3x"><svg version="1.1"
														xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
													<path d="M30 19l-9 9-3-3-2 2 5 5 11-11z"></path> <path
														d="M14 24h10v-3.598c-2.101-1.225-4.885-2.066-8-2.321v-1.649c2.203-1.242 4-4.337 4-7.432 0-4.971 0-9-6-9s-6 4.029-6 9c0 3.096 1.797 6.191 4 7.432v1.649c-6.784 0.555-12 3.888-12 7.918h14v-2z"></path></svg></span>ID
												/ PW 찾기</a></li>
									</ul>
								</div>
							</div>
					...
					<div
						class="col-xl-6 d-flex align-items-center justify-content-center d-none d-md-block order-xl-2">
						<nav class="navbar navbar-expand scroll-x">
						<div
							class="collapse navbar-collapse adonis-tabbed-nav tab-style-2 justify-content-center">
							<div class="d-inline-block">
								<ul
									class="navbar-nav mr-auto ml-auto moving-border mt-3 mt-xl-0">
									<li class="menu-item active"><a
										class="nav-link adonis-ajax-load loaded active m-item"
										href="#" data-target=".browse-content-overview">Home</a></li>
									<li class="menu-item"><a
										class="nav-link adonis-ajax-load m-item"
										href="#browse-all-albums" data-target="#browse-all-albums"
										data-content="parts/browse/all-albums.jsp">Albums</a></li>
									<li class="menu-item"><a
										class="nav-link adonis-ajax-load m-item"
										href="#browse-all-artists" data-target="#browse-all-artists"
										data-content="parts/browse/all-artists.html">Artists</a></li>
									<li class="menu-item"><a
										class="nav-link adonis-ajax-load m-item" href="#browse-charts"
										data-target="#browse-charts"
										data-content="parts/browse/charts.html">Charts</a></li>
									<li class="menu-item"><a
										class="nav-link adonis-ajax-load m-item" href="#browse-news"
										data-target="#browse-news"
										data-content="parts/browse/news.html">news</a></li>
								</ul>
								<hr class="border-hr">
							</div>
						</div>
					...
					<div class="tabs-content">
						<div class="browse-content-overview inactive-hide active mb-4">
							<div id="album-listener" class="album-listener">
								<div class="album-listerer-overlay listener-banner-1"
									id="album-listerer-overlay"></div>
								<div class="container-fluid">
									<div class="d-flex justify-content-center music-img-box mb-3">
										<div class="album-listener-lg d-flex align-items-center">
											<div class="text-center">
												<p class="mb-2">
													<a
														class="btn btn-60-60 btn-primary adonisbounceIn absolute-center adonis-album-button round-btn ml-auto mr-auto "
												...
												<a href="#" class=""><em class="color-black fs-4">Listens
														Album</em></a>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-8 offset-lg-2">
											<div
												class="adonis-carousel nav-middle pt-lg-5 adonis-animate pl-3 pr-3"
												data-animation-item=".owl-item.active"
												data-animation="slideRight" data-loop="no"
												data-auto-width="no" data-dots="no" data-items="4"
												data-nav="yes"
												data-items-responsive="0:1|500:2|768:3|1200:4">
												<div class="gutter-30">
													<div class="owl-carousel owl-theme-adonis">
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/new-releases/new-releases-11@2x .jpg"
																...
																<h5 class="title font-weight-bold">
																	<a href="#">Home For The Holydays</a>
																</h5>
																<p class="sub-title category">
																	<a href="#">David Jame</a>
																</p>
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/new-releases/new-releases-14.jpg"
																		data-2x="assets/images/new-releases/new-releases-14@2x.jpg"
																		alt="">
																	<div class="hover-state">
																		<div class="absolute-bottom-left pl-e-20 pb-e-20">
																			<span class="pointer play-btn-dark round-btn"><i
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/new-releases/new-releases-12.jpg"
																		data-2x="assets/images/new-releases/new-releases-12@2x.jpg"
																		alt="">
																	<div class="hover-state">
																		<div class="absolute-bottom-left pl-e-20 pb-e-20">
																			<span class="pointer play-btn-dark round-btn"><i
																...
																<h5 class="title font-weight-bold">
																	<a href="#">Home For The Holidays</a>
																</h5>
																<p class="sub-title category">
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/new-releases/new-releases-11@2x .jpg"
																		data-2x="assets/images/new-releases/<div class="row">
																	<div class="col-lg-8 offset-lg-2">
																		<div
																			class="adonis-carousel nav-middle pt-lg-5 adonis-animate pl-3 pr-3"
																			data-animation-item=".owl-item.active"
																			...
																			<div class="gutter-30">
																				<div
																					class="owl-carousel owl-theme-adonis owl-loaded owl-drag">
																					...
																					<div class="owl-stage-outer">
																						<div class="owl-stage"
																							style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 937px;">
																							<div class="owl-item active"
																								style="width: 187.332px; opacity: 1; transform: translateX(0px);">
																								<div class="item">
																									<div class="music-img-box">
																										<div
																											class="img-box box-rounded-sm h-d-md-shadow">
																											<img class="retina"
																												src="../assets/images/new-releases/new-releases-10.jpg"
																												data-2x="assets/images/new-releases/new-releases-10@2x.jpg"
																												alt="">
																											<div class="hover-state">
																												<div
																													class="absolute-bottom-left pl-e-20 pb-e-20">
																													<span
																														class="pointer play-btn-dark round-btn"><i
																														class="play-icon"></i></span>
																												</div>
																												<div
																													class="absolute-top-right pr-e-20 pt-e-20">
																													<span class="pointer dropdown-menu-toggle"><span
																														class="adonis-icon icon-4x"><svg
																							...
																							<div class="owl-item" style="width: 187.332px;">
																								<div class="item">
																									<div class="music-img-box">
																										<div
																											class="img-box box-rounded-sm h-d-md-shadow">
																					...
																					<div class="owl-nav">
																						<div class="owl-prev disabled">
																							<span class="adonis-icon icon-4x"><svg
																									xmlns="http://www.w3.org/2000/svg"
																									version="1.1" height="24" viewBox="0 0 24 24">
																									<path
																										d="M10.4 12l5.3-5.3c0.4-0.4 0.4-1 0-1.4s-1-0.4-1.4 0l-6 6c-0.4 0.4-0.4 1 0 1.4l6 6c0.2 0.2 0.5 0.3 0.7 0.3s0.5-0.1 0.7-0.3c0.4-0.4 0.4-1 0-1.4l-5.3-5.3z"></path></svg></span>
																						</div>
																						<div class="owl-next">
																							<span class="adonis-icon icon-4x"><svg
																									xmlns="http://www.w3.org/2000/svg"
																									version="1.1" height="24" viewBox="0 0 24 24">
																									<path
																										d="M15.7 11.3l-6-6c-0.4-0.4-1-0.4-1.4 0s-0.4 1 0 1.4l5.3 5.3-5.3 5.3c-0.4 0.4-0.4 1 0 1.4 0.2 0.2 0.4 0.3 0.7 0.3s0.5-0.1 0.7-0.3l6-6c0.4-0.4 0.4-1 0-1.4z"></path></svg></span>
																						</div>
																					</div>
												...
												<div class="data-prev d-none">
													<span class="adonis-icon icon-4x"><svg
															...
															d="M10.4 12l5.3-5.3c0.4-0.4 0.4-1 0-1.4s-1-0.4-1.4 0l-6 6c-0.4 0.4-0.4 1 0 1.4l6 6c0.2 0.2 0.5 0.3 0.7 0.3s0.5-0.1 0.7-0.3c0.4-0.4 0.4-1 0-1.4l-5.3-5.3z" /></svg></span>
												</div>
												<div class="data-next d-none">
													<span class="adonis-icon icon-4x"><svg
															xmlns="http://www.w3.org/2000/svg" version="1.1"
															height="24" viewBox="0 0 24 24"> <path
															d="M15.7 11.3l-6-6c-0.4-0.4-1-0.4-1.4 0s-0.4 1 0 1.4l5.3 5.3-5.3 5.3c-0.4 0.4-0.4 1 0 1.4 0.2 0.2 0.4 0.3 0.7 0.3s0.5-0.1 0.7-0.3l6-6c0.4-0.4 0.4-1 0-1.4z" /></svg></span>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="master-container-fluid">
						<div class="row">
							<div class="col-md-9 order-md-2 flex-column-content-md">
								<div class="tabs-content">
									<div
										class="browse-content-overview inactive-hide active fluid-reverse-r">
										<section>
										<div class="d-flex">
											<div class="title-box">
											...
											<div
												...
												<a href="#" class="inactive-color mr-4 mb-4">See all <span
													class="adonis-icon pl-1 icon-arrow icon-1x"><svg
															xmlns="http://www.w3.org/2000/svg" version="1.1"> <use
															xlink:href="#icon-see-all-arrow-right"></use></svg></span></a>
											</div>
										</div>
										<div class="adonis-carousel" data-auto-width="yes"
											data-loop="no" data-dots="yes"
											data-responsive-width="0:260px">
											<div class="gutter-30">
												<div class="owl-carousel owl-theme-adonis">
													<div class="item">
														<div class="music-img-box">
													...
													<div class="item">
														<div class="music-img-box">
															...
															<h6 class="title">
																<a href="#">I don'nt wanna do this anymore</a>
															</h6>
															<p class="sub-title category">
																<a href="#">Hellen JB</a>
															</p>
													...
													<div class="item">
														<div class="music-img-box">
															...
															<h6 class="title">
																<a href="#">I don'nt wanna do this</a>
															</h6>
															<p class="sub-title category">
																<a href="#">Adonis Music Pop</a>
															</p>
													...
													<div class="item">
														<div class="music-img-box">
															...
															<h6 class="title">
																<a href="#">Aliquam vulpute</a>
															</h6>
															<p class="sub-title category">
																<a href="#">Jose Feliciano</a>
															</p>
														</div>
													</div>
													<div class="item">
													...
													<div class="item">
														<div class="music-img-box">
															...
															<h6 class="title">
																<a href="#">Badak Yellow</a>
															</h6>
															<p class="sub-title category">
																<a href="#">Michele Buble</a>
															</p>
														</div>
													</div>
													<div class="item">
										...
										<div class=" mb-e-20 mb-e-lg-40"></div>
										</section>

										<section>
										<div class="row">
											<div class="col-lg-6 pr-e-30 pr-lg-15">
												<div class="d-flex flex-row">
													...
													<div
														class="button-right ml-auto ml-auto d-flex align-items-end mb-4">
														<a href="#" class="inactive-color">See all <span
															class="adonis-icon pl-1 icon-arrow icon-1x"><svg
																	xmlns="http://www.w3.org/2000/svg" version="1.1">
																<use xlink:href="#icon-see-all-arrow-right"></use></svg></span></a>
													</div>
												</div>
												<div class="adonis-carousel music-img-box-cont-sm"
													data-auto-width="yes" data-loop="no" data-dots="yes"
													data-responsive-width="0:100%|500:50%">
													<div class="gutter-30">
														<div class="owl-carousel owl-theme-adonis">
															<div class="item">
																<div
																...
																<div
																	...
																	<div class="des">
																		<h6 class="title fs-2">
																			<a href="#">Nothing into Somethings</a>
																		</h6>
																		<p class="sub-title">
																			<a href="#">Sam Hunt</a>
																		</p>
															...
															<div class="item">
																<div
																	...
																	<div class="des">
																		<h6 class="title fs-2">
																			<a href="#">Some Thisng Just Like It</a>
																		</h6>
																		<p>
																			<a href="#" class="inactive-color">Demi Lavato</a>
																		</p>
																	</div>
																	<div
																		class="hover-state d-flex justify-content-between align-items-center">
												...
												<div class="pb-e-20 pb-e-xl-40"></div>
											</div>
											<div class="col-lg-6">
												<div class="d-flex">
													<div class="title-box">
														<h6 class="sub-title inactive-color">World's Hot</h6>
														<h2 class="title h3-md">Label</h2>
													</div>
													<div
														class="button-right ml-auto ml-auto d-flex align-items-end">
														<a href="#" class="inactive-color mr-4 mb-4">See all <span
												...
												<div class="adonis-carousel" data-auto-width="yes"
													data-loop="no" data-dots="yes"
													data-responsive-width="0:95%|400:345px">
													<div class="gutter-30">
														<div class="owl-carousel owl-theme-adonis">
															<div class="item">
																<div class="music-img-box">
																	<div class="img-box box-rounded-sm">
																		<img width="315" height="221"
																			src="../assets/images/brand-logo/yg.png"
																			frameborder="0"></img>
																	...
																	<h4 class="title">
																		<a href="#">YG Entertainment</a>
																	</h4>
																	<p class="sub-title category">
																		<a href="#">Korean hip-hop entertainment</a>
																	</p>
																</div>
															</div>
															<div class="item">
																<div class="music-img-box">
																	<div class="img-box box-rounded-sm">
																		<img width="315" height="221"
																			src="../assets/images/brand-logo/sm.PNG"
																			frameborder="0"></img>
																	</div>
																	<h4 class="title">
																		<a href="#">SM culture&contents</a>
																	</h4>
																	<p class="sub-title category">
																		<a href="#">The beginning of Korean idol
																			entertainment</a>
																	</p>
																</div>
															</div>
															<div class="item">
																<div class="music-img-box">
																	<div class="img-box box-rounded-sm">
																		<img width="315" height="221"
																			src="../assets/images/brand-logo/paro.PNG"
																			frameborder="0"></img>
																	</div>
																	<h4 class="title">
																		<a href="#">Parlophone </a>
																	...
																	<p class="sub-title category">
																		<a href="#">British pop music label</a>
																	</p>
																</div>
															</div>
															<div class="item">
																<div class="music-img-box">
																	<div class="img-box box-rounded-sm">
																		<img width="315" height="221"
																			src="../assets/images/brand-logo/jyp.png"
																			frameborder="0"></img>
																	</div>
																	<h4 class="title">
																		<a href="#">JYP entertainment </a>
																	</h4>
																	<p class="sub-title category">
																		<a href="#">Music production and management
																			company</a>
																	</p>
																</div>
															</div>
															<div class="item">
																<div class="music-img-box">
																	<div class="img-box box-rounded-sm">
																		<img width="315" height="221"
																			src="../assets/images/brand-logo/ce.png"
																			frameborder="0"></img>
																	</div>
																	<h4 class="title">
																		<a href="#">CEDILLE </a>
																	...
																	<p class="sub-title category">
																		<a href="#">American Classic Label</a>
																	</p>
																</div>
															</div>
														</div>
										...
										<div class="d-flex flex-row">
											...
											<div
												class="button-right ml-auto ml-auto d-flex align-items-end mb-4">
												<a href="#" class="inactive-color mr-4">See all <span
													class="adonis-icon pl-1 icon-arrow icon-1x"><svg
															xmlns="http://www.w3.org/2000/svg" version="1.1"> <use
															xlink:href="#icon-see-all-arrow-right"></use></svg></span></a>
											</div>
										...
										<div class="adonis-carousel" data-auto-width="yes"
											data-dots="yes" data-responsive-width="0:80%|400:350px">
											<div class="gutter-30">
												<div class="owl-carousel owl-theme-adonis">
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<iframe width="315" height="221"
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<iframe width="315" height="221"
																	src="https://www.youtube.com/embed/4HG_CJzyX6A"
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<iframe width="315" height="221"
																	src="https://www.youtube.com/embed/Cp56JdkmE9s"
																	frameborder="0"
																	allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
																	allowfullscreen></iframe>
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<iframe width="315" height="221"
																	src="https://www.youtube.com/embed/6YPzivQ1lVc"
																	frameborder="0"
																	allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
																	allowfullscreen></iframe>
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<iframe width="315" height="221"
																	src="https://www.youtube.com/embed/-rey3m8SWQI"
																	frameborder="0"
																	allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
																	allowfullscreen></iframe>
															</div>
													...
													<div class="item">
														<div class="music-img-box">
															...
															<h6 class="title">
																<a href="#">Shallow (A Star Is Born)</a>
															</h6>
															<p class="sub-title category">
																<a href="#">Lady Gaga, Bradley Cooper</a>
															</p>
														</div>
													</div>
												</div>
									...
									<div id="browse-all-albums" class="inactive-hide"></div>
									<div id="browse-all-artists" class="inactive-hide"></div>
									<div id="browse-charts" class="inactive-hide fluid-reverse-r"></div>
							...
							<div class="col-md-3 order-md-1 flex-column-sidebar-md sidebar">
								<div class="widget">
									<h3 class="widget-title h3-md">Popular Genres</h3>
									<div class="tagcloud">
										<a href="#">Acoustic</a> <a href="#">Country</a> <a href="#">Hip-Hop/Rap</a>
										<a href="#">Hard Rock</a> <a href="#">Indie</a> <a href="#">Classic
											Rock</a> <a href="#">Pop</a> <a href="#">Blues</a> <a href="#">Classical</a>
										<a href="#">R&amp;B</a>
									</div>
								</div>
								...
								<div class="widget">
									<h4>Go Moblie</h4>
									<div class="mobile-apps mb-3 mt-4">
										<ul class="list-inline d-inline-flex">
											<li class="mr-2"><img
												src="../assets/images/brand-logo/apple-logo.png" alt=""></li>
											<li><img
												src="../assets/images/brand-logo/google-apps.png" alt=""></li>
										</ul>
									</div>
									<div>
										<label class="mr-4">Language </label> <img
											src="../assets/images/brand-logo/lang-flag.png" alt="">
									</div>
								</div>
								<div class="widget">
									...
									<ul class="inactive-colored-links list-inline mb-0">
										<li class="list-inline-item mr-2"><a href="#">About</a></li>
										<li class="list-inline-item mr-2"><a href="#">Help &
												Support</a></li>
										<li class="list-inline-item mr-2"><a href="#">Privacy</a></li>
										<li class="list-inline-item mr-2"><a href="#">Contact</a></li>
										<li class="list-inline-item"><a href="#">Legal</a></li>
									</ul>
									<p class="copyright">Copyright &copy; 2018 IconikTech. All
										rights reserved.</p>
								</div>
							</div>
						</div>
									...
									<div
										...
										<div class="d-flex align-items-center">
											<span class="adonis-icon text-light pointer mr-2 icon-2x"><svg
													xmlns="http://www.w3.org/2000/svg" version="1.1"> <use
													xlink:href="#icon-heart-blank" /></svg></span> <span
												class="pointer dropdown-menu-toggle"><span
												class="icon-dot-nav-horizontal text-light"></span></span>
										</div>
									</div>
	...
	<svg xmlns="http://www.w3.org/2000/svg" version="1.1"
		class="adonis-svg-library"> <symbol id="icon-horizontal-dots"
		viewBox="0 0 32 32"> <path
		d="M5.681 12.808c-1.763 0-3.192 1.429-3.192 3.192s1.429 3.192 3.192 3.192c1.763 0 3.192-1.429 3.192-3.192v0c0-1.763-1.429-3.192-3.192-3.192v0zM16.322 12.808c-1.763 0-3.192 1.429-3.192 3.192s1.429 3.192 3.192 3.192c1.763 0 3.192-1.429 3.192-3.192v0c0-1.763-1.429-3.192-3.192-3.192v0zM26.963 12.808c-1.763 0-3.192 1.429-3.192 3.192s1.429 3.192 3.192 3.192c1.763 0 3.192-1.429 3.192-3.192v0c0-1.763-1.429-3.192-3.192-3.192v0z"></path>
	</symbol> <symbol id="arrow-right" viewBox="0 0 42 42"> <polygon
		points="42,20 22,20 22,0 20,0 20,20 0,20 0,22 20,22 20,42 22,42 22,22 42,22 " />
	</symbol> <symbol id="arrow-left" viewBox="0 0 24 24"> <path
	...
	</symbol> <symbol id="icon-see-all-arrow-right" viewBox="0 0 24 24"> <path
	...
	</symbol> <symbol id="icon-heart-blank" viewBox="0 0 37 32"> <path
	...
	</symbol> <symbol id="icon-close-notification" viewBox="0 0 24 24"> <path
	...
	</symbol> <symbol id="icon-brand-play-gradient" viewBox="0 0 27 32"> <linearGradient
		id="iconGradientAdonis" x1="0" y1="0" x2="100%" y2="0">
	<stop offset="0%" stop-color="#b08cf9"></stop> <stop offset="100%"
		stop-color="#91a5f4"></stop></linearGradient> <defs> <linearGradient x1="0"
		y1="0" x2="100%" y2="0"> <stop offset="0%"
		stop-color="#b08cf9"></stop> <stop offset="100%" stop-color="#91a5f4"></stop></linearGradient></defs>
	<path fill="url(#iconGradientAdonis)"
		d="M2.594 0.275c-0.257-0.166-0.571-0.265-0.908-0.265-0.932 0-1.688 0.756-1.688 1.688 0 0.028 0.001 0.055 0.002 0.082l-0-0.004v13.246l16.702-6.219zM26.030 14.49l-4.184-2.541-21.846 8.102v10.154c-0.001 0.024-0.002 0.051-0.002 0.079 0 0.927 0.752 1.679 1.679 1.679 0.319 0 0.617-0.089 0.871-0.243l-0.007 0.004c1.501-0.888 22.21-13.433 23.489-14.214 0.52-0.316 0.863-0.88 0.863-1.524s-0.342-1.207-0.855-1.519l-0.008-0.004z"></path>
	</symbol> <symbol id="icon-brand-play" viewBox="0 0 27 32"> <path
		d="M2.594 0.275c-0.257-0.166-0.571-0.265-0.908-0.265-0.932 0-1.688 0.756-1.688 1.688 0 0.028 0.001 0.055 0.002 0.082l-0-0.004v13.246l16.702-6.219zM26.030 14.49l-4.184-2.541-21.846 8.102v10.154c-0.001 0.024-0.002 0.051-0.002 0.079 0 0.927 0.752 1.679 1.679 1.679 0.319 0 0.617-0.089 0.871-0.243l-0.007 0.004c1.501-0.888 22.21-13.433 23.489-14.214 0.52-0.316 0.863-0.88 0.863-1.524s-0.342-1.207-0.855-1.519l-0.008-0.004z"></path>
	</symbol> <symbol id="icon-users" viewBox="0 0 32 32"> <path
	...
	</symbol> <symbol id="icon-songs-3" viewBox="0 0 32 32"> <path
	...
	</symbol> <symbol id="icon-plus" viewBox="0 0 24 24"> <path
	...
	</symbol> <symbol id="icon-bag" viewBox="0 0 26 32"> <path
...
================================================== -->
	...
	<script
		src="../assets/vendors/perfect-scrollbar/js/perfect-scrollbar.min.js"></script>
