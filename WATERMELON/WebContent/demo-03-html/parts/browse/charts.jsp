...
<body>
                ...
                <div class="row">
                    <div class="col-md-9 order-md-2 flex-column-content-md">
                        <main id="main" class="fluid-reverse-r">
                            ...
                            <div class="adonis-carousel music-img-box-cont-sm adonis-animate" data-animation="slideUp" data-animation-item=".item" data-auto-width="yes" data-loop="no" data-dots="yes" data-responsive-width="0:80%|400:1350">
                                <div class="gutter-30">
        ...
        <div class="section-loader preloader negative-overlay"><div class="preloader-overlay"></div></div>
    </div><!--/#site-content-->
