...
%>
<title>WaterMelon - <%=nickname%>'s Profile
</title>
				...
				<div id="userform">
					...
					<div class="tab-content">
						<div class="tab-pane fade active in" id="accountList">
							<form id="accountList" method="post"
								action="/WaterMelon/accountUpdate.water?id=<%=id%>">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											...
											</label> <input disabled="disabled" type="password"
								...
								<div class="mrgn-30-top">
									<button id="btn_AccountUpdate" type="submit"
										class="btn btn-larger btn-block" value="회원정보 수정하기!">
										회원정보 수정하기!</button>
									<button id="btn_AccountDelete" type="button"
										class="btn btn-larger btn-block" value="회원 탈퇴하기!"
										onclick="location.href='/WaterMelon/accountDelete.water?id=<%=id%>'">회원
										탈퇴하기!</button>
