...
<div id="wrap" class="main-wrap">
	...
	<div id="site-header">
		...
		<div class="site-header">
			<div class="master-container-fluid header-inner mb-3 mb-md-4 mt-3 absolute-header">
				<div class="row justify-content-between">
					<div class="col-auto col-xl-3 d-flex align-items-center pr-0">
						<div class="logo">
							<a class="brand d-flex align-items-center" href="../demo-03-html/home.jsp"> 
							...
							<div
								...
								<div class="media notification">
									<div class="user-thumb mr-3 rounded-thumb">
										<img src="../assets/images/browse/browse-overview-6.jpg"
											alt="">
									</div>
								...
								<div class="media notification">
									<div class="user-thumb mr-3 rounded-thumb">
										<img src="../assets/images/browse/browse-overview-5.jpg"
											alt="">
									</div>
									<div class="notification-desc">
										<p>
			...
			<div class="master-container-fluid">
				<section class="album-top-content">
					...
					<div class="row">
						...
						<div class="col-xl-9 flex-column-content-xl" style="padding-top:90px;">
							<h1 >수민님의 MyList</h1>
							
							<div class="button">
							<input type="button" value="전체 재생">
							</div>
						</div>
					</div>
					<div class="pb-4"></div>
					...
					<div class="row">
						<div class="col-md-9 order-md-2 flex-column-content-md">
							...
							<ul class="adonis-album-list pb-5">
								<li>
									<div class="item-number h6 inactive-color">번호</div>
									<div class="item-title h6 inactive-color">제목</div>
									<div class="item-genre h6 inactive-color">가수</div>
									<div class="item-duration h6 inactive-color">장르</div>
									<div class="item-duration h6 inactive-color">시간</div>
								</li> 
								<li class="item hover-bg-item">
									<div class="item-number">
										<span class="hover-hide">번호</span> <span
									...
									<div class="item-genre">가수</div>
									<div class="item-duration">장르</div>
									<div class="item-tools">시간</div>
									<div class="hover-bg gradient-adonis"></div>
								</li>
							</ul>
							</main>
						</div>
						<div class="col-md-3 order-md-1 flex-column-sidebar-md sidebar"></div>
					</div>
				</section>
			</div>
		</div>
